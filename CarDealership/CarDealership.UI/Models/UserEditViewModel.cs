...
namespace CarDealership.UI.Models
{
    ...
    {
        // need user to be edited, role dropdown, and passwords
        ...
        public IEnumerable<ValidationResult> Validate(ValidationContext validationContext)
        {
            ...
            // first name, last name, email, current password must be filled out
            ...
            if (string.IsNullOrEmpty(CurrentPassword))
                errors.Add(new ValidationResult("Please enter the user's current Password."));
